...
using BarcodeUtility.Symbologies;

namespace BarcodeUtility
{
    #region Enums
    public enum BARCODE_ENCODE_TYPE : int
    {
        UNSPECIFIED,
        UPCA,
        UPCE,
    ...
    {
        #region Variables
        private IBarcode ibarcode = new BarcodeUtility.Symbologies.Blank();
        private string Raw_Data = "";
        private string Encoded_Value = "";
        private string _Country_Assigning_Manufacturer_Code = "N/A";
        private BARCODE_ENCODE_TYPE Encoded_Type = BARCODE_ENCODE_TYPE.UNSPECIFIED;
        ...
        /// </summary>
        public BARCODE_ENCODE_TYPE EncodedType
        {
        ...
        internal Image Encode()
        {
            ...
            if (this.EncodedType == BARCODE_ENCODE_TYPE.UNSPECIFIED) 
            ...
            {
                case BARCODE_ENCODE_TYPE.UCC12:
                case BARCODE_ENCODE_TYPE.UPCA: //Encode_UPCA();
                    ibarcode = new UPCA(Raw_Data);
                    break;
                case BARCODE_ENCODE_TYPE.UCC13:
                case BARCODE_ENCODE_TYPE.EAN13: //Encode_EAN13();
                    ibarcode = new EAN13(Raw_Data);
                    break;
                case BARCODE_ENCODE_TYPE.Interleaved2of5: //Encode_Interleaved2of5();
                    ibarcode = new Interleaved2of5(Raw_Data);
                    break;
                case BARCODE_ENCODE_TYPE.Industrial2of5:
                case BARCODE_ENCODE_TYPE.Standard2of5: //Encode_Standard2of5();
                    ibarcode = new Standard2of5(Raw_Data);
                    break;
                case BARCODE_ENCODE_TYPE.LOGMARS:
                case BARCODE_ENCODE_TYPE.CODE39: //Encode_Code39();
                    ibarcode = new Code39(Raw_Data);
                    break;
                case BARCODE_ENCODE_TYPE.CODE39Extended:
                    ibarcode = new Code39(Raw_Data, true);
                    break;
                case BARCODE_ENCODE_TYPE.CODE39_Mod43:
                    ibarcode = new Code39(Raw_Data, false, true);
                    break;
                case BARCODE_ENCODE_TYPE.Codabar: //Encode_Codabar();
                    ibarcode = new Codabar(Raw_Data);
                    break;
                case BARCODE_ENCODE_TYPE.PostNet: //Encode_PostNet();
                    ibarcode = new Postnet(Raw_Data);
                    break;
                case BARCODE_ENCODE_TYPE.ISBN:
                case BARCODE_ENCODE_TYPE.BOOKLAND: //Encode_ISBN_Bookland();
                    ibarcode = new ISBN(Raw_Data);
                    break;
                case BARCODE_ENCODE_TYPE.JAN13: //Encode_JAN13();
                    ibarcode = new JAN13(Raw_Data);
                    break;
                case BARCODE_ENCODE_TYPE.UPC_SUPPLEMENTAL_2DIGIT: //Encode_UPCSupplemental_2();
                    ibarcode = new UPCSupplement2(Raw_Data);
                    break;
                case BARCODE_ENCODE_TYPE.MSI_Mod10:
                case BARCODE_ENCODE_TYPE.MSI_2Mod10:
                case BARCODE_ENCODE_TYPE.MSI_Mod11:
                case BARCODE_ENCODE_TYPE.MSI_Mod11_Mod10:
                case BARCODE_ENCODE_TYPE.Modified_Plessey: //Encode_MSI();
                    ibarcode = new MSI(Raw_Data, Encoded_Type);
                    break;
                case BARCODE_ENCODE_TYPE.UPC_SUPPLEMENTAL_5DIGIT: //Encode_UPCSupplemental_5();
                    ibarcode = new UPCSupplement5(Raw_Data);
                    break;
                case BARCODE_ENCODE_TYPE.UPCE: //Encode_UPCE();
                    ibarcode = new UPCE(Raw_Data);
                    break;
                case BARCODE_ENCODE_TYPE.EAN8: //Encode_EAN8();
                    ibarcode = new EAN8(Raw_Data);
                    break;
                case BARCODE_ENCODE_TYPE.USD8:
                case BARCODE_ENCODE_TYPE.CODE11: //Encode_Code11();
                    ibarcode = new Code11(Raw_Data);
                    break;
                case BARCODE_ENCODE_TYPE.CODE128: //Encode_Code128();
                    ibarcode = new Code128(Raw_Data);
                    break;
                case BARCODE_ENCODE_TYPE.CODE128A:
                    ibarcode = new Code128(Raw_Data, Code128.TYPES.A);
                    break;
                case BARCODE_ENCODE_TYPE.CODE128B:
                    ibarcode = new Code128(Raw_Data, Code128.TYPES.B);
                    break;
                case BARCODE_ENCODE_TYPE.CODE128C:
                    ibarcode = new Code128(Raw_Data, Code128.TYPES.C);
                    break;
                case BARCODE_ENCODE_TYPE.ITF14:
                    ibarcode = new ITF14(Raw_Data);
                    break;
                case BARCODE_ENCODE_TYPE.CODE93:
                    ibarcode = new Code93(Raw_Data);
                    break;
                case BARCODE_ENCODE_TYPE.TELEPEN:
                    ibarcode = new Telepen(Raw_Data);
                    break;
                case BARCODE_ENCODE_TYPE.FIM:
                    ibarcode = new FIM(Raw_Data);
                    break;
                case BARCODE_ENCODE_TYPE.PHARMACODE:
                ...
                default:
                    {
                        ...
                        if (this.Encoded_Type == BARCODE_ENCODE_TYPE.PostNet)
                            iBarWidthModifier = 2;
        ...
        /// <param name="Height">Height of the resulting barcode.(pixels)</param>
        /// <returns>Image representing the barcode.</returns>
        public static Image DoEncode(BARCODE_ENCODE_TYPE iType, string Data, bool IncludeLabel, int Width, int Height)
        {
            using (Barcode b = new Barcode())
            {
                b.IncludeLabel = IncludeLabel;
        ...
        /// <param name="BackColor">Background color</param>
        /// <returns>Image representing the barcode.</returns>
        public static Image DoEncode(BARCODE_ENCODE_TYPE iType, string Data, bool IncludeLabel, Color DrawColor, Color BackColor)
        {
            using (Barcode b = new Barcode())
            {
                b.IncludeLabel = IncludeLabel;
        ...
        /// <param name="XML">XML representation of the data and the image of the barcode.</param>
        /// <returns>Image representing the barcode.</returns>
        public static Image DoEncode(BARCODE_ENCODE_TYPE iType, string Data, bool IncludeLabel, Color DrawColor, Color BackColor, int Width, int Height, ref string XML)
        {
            using (Barcode b = new Barcode())
            {
                b.IncludeLabel = IncludeLabel;
